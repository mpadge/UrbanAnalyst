...
* @returns {string}
*/
export function uamutate(json_data1, json_data2, varname, nentries) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(json_data1, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(json_data2, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(varname, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        wasm.uamutate(retptr, ptr0, len0, ptr1, len1, ptr2, len2, nentries);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('uamutations_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
