...
* @returns {number}
*/
export function uamutate(data1, data2, varname_ptr, varname_len, nentries) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.uamutate(retptr, addHeapObject(data1), addHeapObject(data2), varname_ptr, varname_len, nentries);
