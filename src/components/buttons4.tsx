...
export default function Buttons(props: ButtonProps) {
  ...
  const thirdHref =
    props.buttons.third == null ? "/" : getHref(props.buttons.third);
  const Third =
    props.buttons.third == null ? "" : capitaliseFirst(props.buttons.third);
  const fourthHref =
    props.buttons.fourth == null ? "/" : getHref(props.buttons.fourth);
  const Fourth =
    props.buttons.fourth == null ? "" : capitaliseFirst(props.buttons.fourth);
